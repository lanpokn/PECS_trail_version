...
def Rotate_360_high_ICNS():
    ...
    out.release()
    cap.release()
    # ev_full.write('D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/R_360_H_ICNS2.dat'.format(lat, jit, ref, tau, th, th_noise))
    ev_full.write('D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/R_360_H_ICNS.hdf5'.format(lat, jit, ref, tau, th, th_noise),cap.get(cv2.CAP_PROP_FRAME_WIDTH),cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
    # events_data = EventsData()
    # events_data.read_real_events('D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/R_360_H_ICNS2.dat'.format(lat, jit, ref, tau, th, th_noise), 100000)
    # ev_data1 = events_data.events[0]
    # events_data2 = EventsData()
    # events_data2.read_IEBCS_events('D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/R_360_H_ICNS2.dat'.format(lat, jit, ref, tau, th, th_noise), 100000)
    # ev_data2 = events_data2.events[0]
    # point_cloud = events_data.display_events_3D(ev_data1,0,5000)
    # View_3D(point_cloud)
    # point_cloud = events_data2.display_events_3D(ev_data2,0,5000)
    # View_3D(point_cloud)    
    end_time = time.time()
    total_time = end_time - start_time
    print("Total time of ICNS", total_time)
...
def Compare_Real_and_PBES(Realpath, simPath,time_intervel = 100000,C=100,N=31):
    ...
    # factor = int((21153/2857)/0.6)
    # base = 0
    # point_cloud = events_data.display_events_3D(ev_data0,35000*factor,36500*factor)
    # View_3D(point_cloud)
    # point_cloud = events_data.display_events_3D(ev_data1,35000*factor/4,36500*factor/4)
    # View_3D(point_cloud)
    # img1 = events_data.display_events(ev_data0,base+35000*factor,base+36500*factor)
    # cv2.imshow("real",img1)
    # cv2.waitKey()
    # img2 = events_data.display_events(ev_data1,base+35000*factor,base+36500*factor)
    # cv2.imshow("sim",img2)
    # cv2.waitKey()
...
def Compare_Real_and_Volt(Realpath, simPath,time_intervel = 100000):
    ...
    point_cloud = events_data.display_events_3D(ev_data0,35000*factor,36500*factor)
    View_3D(point_cloud)
    point_cloud = events_data.display_events_3D(ev_data1,35000*factor/1.5,39500*factor/1.5)
    View_3D(point_cloud)
    # img1 = events_data.display_events(ev_data0,base+20000*factor,base+25000*factor,downsample = True)
    # cv2.imshow("real",img1)
    # cv2.waitKey()
    # img2 = events_data_V2E.display_events(ev_data1,base+20000*factor*0.6,base+25000*factor*0.6,downsample = False)
    # cv2.imshow("sim",img2)
    # cv2.waitKey()
...
def Compare_Real_PECS_and_Volt(Realpath, simPath,PECS_path, time_intervel = 100000):
    """use it to test functions
    """    
    events_data = EventsData()
    events_data_V2E = EventsData()
    events_data_PECS = EventsData()
    #make sure the video is long enough, or it can't disolay normally
    events_data.read_real_events(Realpath, time_intervel)
    events_data_V2E.read_Volt_events(simPath, time_intervel)
    events_data_PECS.read_IEBCS_events(PECS_path, time_intervel)

    #3D output is the best way to calibrate
    ev_data0 = events_data.events[0]
    ev_data1 = events_data_V2E.events[0]
    ev_data2 = events_data_PECS.events[0]
    ...
    # View_3D(point_cloud)
    #15000,46000
    img1 = events_data.display_events(ev_data0,base+15000*factor,base+46000*factor,downsample = True)
    cv2.imshow("real",img1)
    cv2.waitKey()
    img2 = events_data.display_events(ev_data1,base+15000*factor,base+46000*factor,downsample = True)
    cv2.imshow("volt",img2)
    cv2.waitKey()
    img3 = events_data.display_events(ev_data2,base+15000*factor,base+46000*factor,downsample = True)
    cv2.imshow("sim",img3)
    cv2.waitKey()
...
Get_Result_Of_DIfferent_C_N(100,8)
# Get_Result_Of_DIfferent_C_N(100,7)
# Get_Result_Of_DIfferent_C_N(100,6)
Get_Result_Of_DIfferent_C_N(100,5)
Get_Result_Of_DIfferent_C_N(100,4)
Get_Result_Of_DIfferent_C_N(100,3)
Get_Result_Of_DIfferent_C_N(100,2)
Get_Result_Of_DIfferent_C_N(100,1)
#8，30，120，480，1920
# Rotate_360_high()
...
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/High_360_120deg.hdf5",'D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/R_360_H_ICNS.dat',50000)
...
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/Rotate_360_low/LOW_360_120deg.hdf5",'D:/2023/computional imaging/my_pbrt/output/Rotate_360_low/R_360_L_ICNS.dat',50000)
...
# Rotate_60_high()
# Rotate_60_high_ICNS()
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/Rotate_60_high/High_60_120deg.hdf5","D:/2023/computional imaging/my_pbrt/output/Rotate_60_high/R_60_H_PBES.dat",500000)
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/Rotate_60_high/High_60_120deg.hdf5",'D:/2023/computional imaging/my_pbrt/output/Rotate_60_high/R_60_H_ICNS.dat',50000)
...
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/trans_1mps_high/trans_1mps_H.hdf5","D:/2023/computional imaging/my_pbrt/output/trans_1mps_high/T_1_H_PBES.dat",800000)
...
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/trans_06mps_H.hdf5","D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/T_06_H_PBES.dat",800000)
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/trans_06mps_H.hdf5",'D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/T_06_H_ICNS.dat',900000)
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/trans_06mps_H.hdf5",'D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/T_06_H_ESIM.dat',900000)
# Compare_Real_and_V2E("D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/trans_06mps_H.hdf5",'D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/T_06_H_v2e.txt',900000)

# Trans_1mps_low()
# Trans_1mps_low_ICNS()
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/trans_1mps_low/trans_1mps_L.hdf5","D:/2023/computional imaging/my_pbrt/output/trans_1mps_low/T_1_L_PBES.dat",800000)
...
#addition experiment
# Compare_Real_and_Volt("D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/High_360_120deg.hdf5",'D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/Rotate_360_high_Volt.txt',10000)
...
# Compare_Real_and_Volt("D:/2023/computional imaging/my_pbrt/output/trans_1mps_high/trans_1mps_H.hdf5",'D:/2023/computional imaging/my_pbrt/DVS-Voltmeter-main/data_samples/output/T_1_H_Volt.txt' , 800000)
# Compare_Real_and_Volt("D:/2023/computional imaging/my_pbrt/output/trans_06mps_high/trans_06mps_H.hdf5",'D:/2023/computional imaging/my_pbrt/DVS-Voltmeter-main/data_samples/output/T_0.6_H_Volt.txt',8000000)
# Compare_Real_and_Volt("D:/2023/computional imaging/my_pbrt/output/trans_1mps_low/trans_1mps_L.hdf5",'D:/2023/computional imaging/my_pbrt/DVS-Voltmeter-main/data_samples/output/T_1_L_Volt.txt',800000)

# Compare_Real_PECS_and_Volt("D:/2023/computional imaging/my_pbrt/output/Rotate_360_low/LOW_360_120deg.hdf5",'D:/2023/computional imaging/my_pbrt/output/Rotate_360_low/Rotate_360_low_Volt.txt',"D:/2023/computional imaging/my_pbrt/output/Rotate_360_low/R_360_L_PBES.dat")
# Compare_Real_PECS_and_Volt("D:/2023/computional imaging/my_pbrt/output/trans_1mps_high/trans_1mps_H.hdf5",'D:/2023/computional imaging/my_pbrt/DVS-Voltmeter-main/data_samples/output/T_1_H_Volt.txt',"D:/2023/computional imaging/my_pbrt/output/trans_1mps_high/T_1_H_PBES.dat",800000)
